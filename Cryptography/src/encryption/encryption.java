...
public class encryption extends JPanel implements ActionListener {
    ...
    public encryption()
    {
     ...
     f2=new Font(Font.SANS_SERIF,Font.PLAIN, 18);
    ...
    tplain_txt.setBounds(220, 20, 350, 30);
    

    enc_lbl.setBounds(20,80,200,30);
    tenc_txt.setBounds(220,80,350,30);

    dec_lbl.setBounds(20,140, 200,30);
    tdec_txt.setBounds(220,140,350,30);

    bencrypt.setBounds(30,200,160,40);
    bdecrypt.setBounds(240,200,160,40);

    bclear.setBounds(30,240,160,40);
    bexit.setBounds(240,240,160,40);
    ...
    if(action.equals("Encryption"))
    {
         ...
         x=tenc_txt.getText().toString().toLowerCase();
        if(k.equals(""))
        {
            tplain_txt.setFocusable(true);
            JOptionPane.showMessageDialog(this, "Please Enter Plain Text !", "Warning", JOptionPane.WARNING_MESSAGE);
